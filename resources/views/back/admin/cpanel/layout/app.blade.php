...
<head>
    ...
    <title>بنك الدم | لوحة التحكم</title>
    ...
    <!-- treeview style -->
    <link rel="stylesheet" href="{{ asset('admin') }}/assets/dist/css/treeview-rtl.css')}}" />
...
@include('back.admin.cpanel.layout.navbar')
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        @include('back.admin.cpanel.layout.sidebar')
...
@yield('content')
        ...
        @include('back.admin.cpanel.layout.footer')
