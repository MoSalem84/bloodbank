        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <a href="{{ route('admin.cpanel.cities.index')}}" class="small-box-footer">More info <i
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                    ...
                    <a href="{{ route ('admin.cpanel.posts.index')}}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
                        ...
                        <div class="direct-chat-messages">
                            ...
                            <div class="direct-chat-msg">
                                ...
                                <img class="direct-chat-img"
                                    src="{{ asset('admin') }}/assets/dist/img/user1-128x128.jpg"
                            ...
                            <div class="direct-chat-msg right">
                                ...
                                <!-- /.direct-chat-infos -->
                                <img class="direct-chat-img"
                                    src="{{ asset('admin') }}/assets/dist/img/user3-128x128.jpg"
                                    alt="message user image">
                                <!-- /.direct-chat-img -->
                                <div class="direct-chat-text">
                        ...
                        <div class="direct-chat-contacts">
                            <ul class="contacts-list">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ asset('admin') }}/assets/dist/img/user7-128x128.jpg">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ asset('admin') }}/assets/dist/img/user5-128x128.jpg">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ asset('admin') }}/assets/dist/img/user6-128x128.jpg">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img"
                                            src="{{ asset('admin') }}/assets/dist/img/user8-128x128.jpg">
