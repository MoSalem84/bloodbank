...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('اضافة مدير جديد ') }}</div>
                @include('back.inc.message')

                        <div class="card-body">
                    <form method="POST" action="{{ route('admin.cpanel.admins.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="phone" class="col-md-4 col-form-label text-md-end">{{ __('الموبايل ') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="roles" class="col-md-4 col-form-label text-md-end">{{ __('الرتبة') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="status" class="col-md-4 col-form-label text-md-end">{{ __('حالة المدير ') }}</label>
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-primary btn-sm" href="{{ route('admin.cpanel.admins.index') }}">رجوع</a>
                            </div>
                        </div>
